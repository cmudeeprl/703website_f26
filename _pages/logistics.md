...
The class requirements include *7 homework assignments* (35% of the grade), *1 midterm* (35% of the grade), *one project* (35% of the grade). By the end of this class you should have a good understanding of the basic methodologies in deep reinforcement learning, and be able to use them to solve real problems of modest complexity.
...
**No more than 2 grace days may be used on any single assignment**.

Any assignment submitted more than 2 days past the deadline (or the date the student no longer has late day credit) will get **zero credit**.
